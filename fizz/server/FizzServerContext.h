...
class FizzServerContext {
 ...
 private:
  ...
  std::vector<NamedGroup> supportedGroups_ = {
      ...
      NamedGroup::p256_ntru509, NamedGroup::p384_ntru677, NamedGroup::p521_ntru821,
      NamedGroup::p256_lightsaber, NamedGroup::p384_saber, NamedGroup::p521_firesaber,
      NamedGroup::akcn, NamedGroup::akcn_hybrid}; //fzhang
