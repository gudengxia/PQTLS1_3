...
std::shared_ptr<PeerCert> DelegatedCredentialFactory::makeCredential(
  ...
  switch (CertUtils::getKeyType(pubKey)) {
    ...
    case KeyType::Dilithium2: 
      return std::make_shared<PeerDelegatedCredential<KeyType::Dilithium2>>(
          std::move(cert), std::move(pubKey), std::move(credential));
    case KeyType::P256_Dilithium2: 
      return std::make_shared<PeerDelegatedCredential<KeyType::P256_Dilithium2>>(
          std::move(cert), std::move(pubKey), std::move(credential));
    case KeyType::Dilithium3:
      return std::make_shared<PeerDelegatedCredential<KeyType::Dilithium3>>(
          std::move(cert), std::move(pubKey), std::move(credential));
    case KeyType::P256_Dilithium3:
      return std::make_shared<PeerDelegatedCredential<KeyType::P256_Dilithium3>>(
          std::move(cert), std::move(pubKey), std::move(credential));
    case KeyType::Dilithium4: 
      return std::make_shared<PeerDelegatedCredential<KeyType::Dilithium4>>(
          std::move(cert), std::move(pubKey), std::move(credential));
    case KeyType::P384_Dilithium4:
      return std::make_shared<PeerDelegatedCredential<KeyType::P384_Dilithium4>>(
          std::move(cert), std::move(pubKey), std::move(credential));
    case KeyType::Mulan: 
      return std::make_shared<PeerDelegatedCredential<KeyType::Mulan>>(
          std::move(cert), std::move(pubKey), std::move(credential));
    case KeyType::P256_Mulan:
      return std::make_shared<PeerDelegatedCredential<KeyType::P256_Mulan>>(
          std::move(cert), std::move(pubKey), std::move(credential));
    case KeyType::Aigis: 
      return std::make_shared<PeerDelegatedCredential<KeyType::Aigis>>(
          std::move(cert), std::move(pubKey), std::move(credential));
    case KeyType::P256_Aigis: 
      return std::make_shared<PeerDelegatedCredential<KeyType::P256_Aigis>>(
          std::move(cert), std::move(pubKey), std::move(credential));
    case KeyType::Falcon512: 
      return std::make_shared<PeerDelegatedCredential<KeyType::Falcon512>>(
          std::move(cert), std::move(pubKey), std::move(credential));
    case KeyType::P256_Falcon512:
      return std::make_shared<PeerDelegatedCredential<KeyType::P256_Falcon512>>(
          std::move(cert), std::move(pubKey), std::move(credential));
    case KeyType::Falcon1024: 
      return std::make_shared<PeerDelegatedCredential<KeyType::Falcon1024>>(
          std::move(cert), std::move(pubKey), std::move(credential));
    case KeyType::P521_Falcon1024:
      return std::make_shared<PeerDelegatedCredential<KeyType::P521_Falcon1024>>(
          std::move(cert), std::move(pubKey), std::move(credential));
    /********************************fzhang end ****************************/
  }
