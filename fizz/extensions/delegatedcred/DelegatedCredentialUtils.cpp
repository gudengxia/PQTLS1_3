...
DelegatedCredential DelegatedCredentialUtils::generateCredential(
  ...
  switch (CertUtils::getKeyType(credKey)) {
    ...
    case KeyType::Dilithium2:
      credKeySchemes = CertUtils::getSigSchemes<KeyType::Dilithium2>();
      break;
    case KeyType::P256_Dilithium2:
      credKeySchemes = CertUtils::getSigSchemes<KeyType::P256_Dilithium2>();
      break;
    case KeyType::Dilithium3:
      credKeySchemes = CertUtils::getSigSchemes<KeyType::Dilithium3>();
      break;
    case KeyType::P256_Dilithium3:
      credKeySchemes = CertUtils::getSigSchemes<KeyType::P256_Dilithium3>();
      break;
    case KeyType::Dilithium4:
      credKeySchemes = CertUtils::getSigSchemes<KeyType::Dilithium4>();
      break;
    case KeyType::P384_Dilithium4:
      credKeySchemes = CertUtils::getSigSchemes<KeyType::P384_Dilithium4>();
      break;
    case KeyType::Mulan:
      credKeySchemes = CertUtils::getSigSchemes<KeyType::Mulan>();
      break;
    case KeyType::P256_Mulan:
      credKeySchemes = CertUtils::getSigSchemes<KeyType::P256_Mulan>();
      break;
    case KeyType::Aigis:
      credKeySchemes = CertUtils::getSigSchemes<KeyType::Aigis>();
      break;
    case KeyType::P256_Aigis:
      credKeySchemes = CertUtils::getSigSchemes<KeyType::P256_Aigis>();
      break;
    case KeyType::Falcon512:
      credKeySchemes = CertUtils::getSigSchemes<KeyType::Falcon512>();
      break;
    case KeyType::P256_Falcon512:
      credKeySchemes = CertUtils::getSigSchemes<KeyType::P256_Falcon512>();
      break;
    case KeyType::Falcon1024:
      credKeySchemes = CertUtils::getSigSchemes<KeyType::Falcon1024>();
      break;
    case KeyType::P521_Falcon1024:
      credKeySchemes = CertUtils::getSigSchemes<KeyType::P521_Falcon1024>();
      break;
    /**************************fzhang end********************/
  }
