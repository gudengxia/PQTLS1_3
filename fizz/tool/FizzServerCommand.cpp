...
void printUsage() {
  ...
  std::cerr
    ...
    << " -sig s1:...              (colon-separated list of signature in preference order.\n"      //fzhang
    << " -kex g1:...              (colon-separated list of groups or kem in preference order.\n"; //fzhang
  // clang-format on
}
...
int fizzServerCommand(const std::vector<std::string>& args) {
  ...
  //Context->setSupportedGroups(supportedgroups); //fzhang
  //clientContext->setDefaultShares(supportedgroups); //fzhang
      ...
      try {
        ...
        switch (CertUtils::getKeyType(credPrivKey)) {
          ...
          case KeyType::Dilithium2:
            cert = std::make_unique<
                fizz::extensions::SelfDelegatedCredentialImpl<KeyType::Dilithium2>>(
                std::move(certs),
                std::move(credPrivKey),
                std::move(*cred),
                compressors);
          ...
          case KeyType::P256_Dilithium2:
            cert = std::make_unique<
                fizz::extensions::SelfDelegatedCredentialImpl<KeyType::P256_Dilithium2>>(
                std::move(certs),
                std::move(credPrivKey),
                std::move(*cred),
                compressors);
           ...
           case KeyType::Dilithium3:
            cert = std::make_unique<
                fizz::extensions::SelfDelegatedCredentialImpl<KeyType::Dilithium3>>(
                std::move(certs),
                std::move(credPrivKey),
                std::move(*cred),
                compressors);
          ...
          case KeyType::P256_Dilithium3:
            cert = std::make_unique<
                fizz::extensions::SelfDelegatedCredentialImpl<KeyType::P256_Dilithium3>>(
                std::move(certs),
                std::move(credPrivKey),
                std::move(*cred),
                compressors);
           ...
           case KeyType::Dilithium4:
            cert = std::make_unique<
                fizz::extensions::SelfDelegatedCredentialImpl<KeyType::Dilithium4>>(
                std::move(certs),
                std::move(credPrivKey),
                std::move(*cred),
                compressors);
          ...
          case KeyType::P384_Dilithium4:
            cert = std::make_unique<
                fizz::extensions::SelfDelegatedCredentialImpl<KeyType::P384_Dilithium4>>(
                std::move(certs),
                std::move(credPrivKey),
                std::move(*cred),
                compressors);
           ...
           case KeyType::Mulan:
            cert = std::make_unique<
                fizz::extensions::SelfDelegatedCredentialImpl<KeyType::Mulan>>(
                std::move(certs),
                std::move(credPrivKey),
                std::move(*cred),
                compressors);
          ...
          case KeyType::P256_Mulan:
            cert = std::make_unique<
                fizz::extensions::SelfDelegatedCredentialImpl<KeyType::P256_Mulan>>(
                std::move(certs),
                std::move(credPrivKey),
                std::move(*cred),
                compressors);
           ...
           case KeyType::Aigis:
            cert = std::make_unique<
                fizz::extensions::SelfDelegatedCredentialImpl<KeyType::Aigis>>(
                std::move(certs),
                std::move(credPrivKey),
                std::move(*cred),
                compressors);
          ...
          case KeyType::P256_Aigis:
            cert = std::make_unique<
                fizz::extensions::SelfDelegatedCredentialImpl<KeyType::P256_Aigis>>(
                std::move(certs),
                std::move(credPrivKey),
                std::move(*cred),
                compressors);
           ...
           case KeyType::Falcon512:
            cert = std::make_unique<
                fizz::extensions::SelfDelegatedCredentialImpl<KeyType::Falcon512>>(
                std::move(certs),
                std::move(credPrivKey),
                std::move(*cred),
                compressors);
          ...
          case KeyType::P256_Falcon512:
            cert = std::make_unique<
                fizz::extensions::SelfDelegatedCredentialImpl<KeyType::P256_Falcon512>>(
                std::move(certs),
                std::move(credPrivKey),
                std::move(*cred),
                compressors);
          ...
          case KeyType::Falcon1024:
            cert = std::make_unique<
                fizz::extensions::SelfDelegatedCredentialImpl<KeyType::Falcon1024>>(
                std::move(certs),
                std::move(credPrivKey),
                std::move(*cred),
                compressors);
          ...
          case KeyType::P521_Falcon1024:
            cert = std::make_unique<
                fizz::extensions::SelfDelegatedCredentialImpl<KeyType::P521_Falcon1024>>(
                std::move(certs),
                std::move(credPrivKey),
                std::move(*cred),
                compressors);
