...
int fizzServerBenchmarkCommand(const std::vector<std::string>& args) {
  ...
  serverContext->setSupportedSigSchemes(
      {SignatureScheme::rsa_pss_sha256, SignatureScheme::ecdsa_secp256r1_sha256,SignatureScheme::ecdsa_secp384r1_sha384,
...
std::vector<SignatureScheme> supportedSigSchemes_ = {
     /*********************fzhang start*********************/
      SignatureScheme::p256_dilithium2, SignatureScheme::p256_dilithium3, SignatureScheme::p384_dilithium4, 
      SignatureScheme::p256_mulan, SignatureScheme::p256_aigis,
      SignatureScheme::p256_falcon512, SignatureScheme::p521_falcon1024,
      /*********************fzhang end***********************/
      SignatureScheme::ecdsa_secp256r1_sha256,
      SignatureScheme::rsa_pss_sha256};
  std::vector<NamedGroup> supportedGroups_ = {NamedGroup::x25519, NamedGroup::p521_kyber1024,
                                              NamedGroup::secp256r1, NamedGroup::akcn_hybrid}; //fzhang
